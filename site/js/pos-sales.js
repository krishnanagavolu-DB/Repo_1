...
let giftChart = null;
const GIFT_COLORS = { "Gift Card": "#F6E300", "Dutch Pass": "#006098" };
...
const IMPORT_STEPS = [
  ...
  "Run <code>python3 scripts/import_pos_sales.py &lt;path-to-export&gt;</code> to validate and copy it into both site data folders.",
  "Commit the updated <code>site/data/in_shop_sales_data.json</code> and redeploy.",
];
